...
public class FarmStationScreen extends MachineScreen<FarmingStationMenu> {
    ...
    public FarmStationScreen(FarmingStationMenu menu, Inventory inventory, Component title) {
